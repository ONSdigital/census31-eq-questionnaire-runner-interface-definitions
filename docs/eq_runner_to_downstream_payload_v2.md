...
| **flushed**                  | Whether the `surveyresponse`was flushed or not. This will be `true` if the `surveyresponse` has been flushed and `false` otherwise. Feedback cannot be flushed.                                                                                                                             |
